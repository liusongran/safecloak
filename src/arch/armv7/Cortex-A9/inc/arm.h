...
#define MIDR_PRIMARY_PART_NUM_MASK	((1 << (MIDR_PRIMARY_PART_NUM_WIDTH)) - 1)

#define MIDR_IMPLEMENTER_SHIFT		24
#define MIDR_IMPLEMENTER_WIDTH		8
#define MIDR_IMPLEMENTER_MASK		((1 << (MIDR_IMPLEMENTER_WIDTH)) - 1)
...
#define CNTKCTL_PL0PCTEN	(1 << 0) /* physical counter el0 access enable */
//#define CNTKCTL_PL0VCTEN	BIT(1) /* virtual counter el0 access enable */
#define CNTKCTL_PL0VCTEN	(1 << 1) /* virtual counter el0 access enable */
